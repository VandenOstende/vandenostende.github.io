...
// ============================================================
import { localToLatLon } from './basemap.js?v=cad5baee';
import { STALL_TYPES } from './solver.js?v=cad5baee';
import { polyOf, ribbonPoly, zebraQuads, hatchQuads, STRIPE_SPEC } from './geometry.js?v=cad5baee';
import { ANNOT_TYPES, surfaceOf } from './annots.js?v=cad5baee';
import { PICTOS } from './pictos.js?v=cad5baee';
import { buildingDesign, DEFAULT_USE, PART_COLORS, materialOf, WALL_ROLES } from './buildings.js?v=cad5baee';
